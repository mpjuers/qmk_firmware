...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_GRV] = ACTION_TAP_DANCE_DOUBLE(KC_ESC, KC_GRV)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = {
        ...
        {KC_TRNS, DYN_REC_START1,   DYN_REC_STOP,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP, KC_INS,  KC_TRNS, KC_PSCR, KC_SLCK, KC_PAUS, KC_TRNS},
        {KC_CAPS, DYN_MACRO_PLAY1,  KC_TRNS,        KC_PGDN, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_HOME, KC_PGUP, KC_PWR,  KC_TRNS},
